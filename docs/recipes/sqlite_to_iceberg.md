...
`nucleus sql` runs DuckDB zero-copy against the Iceberg asset via `Table.scan().to_duckdb(...)` ([`docs/internal/research/pyiceberg.md`](../internal/research/pyiceberg.md) §5).
...
Hit any of these? Log to [`docs/internal/research/ai_hallucinations.md`](../internal/research/ai_hallucinations.md).
