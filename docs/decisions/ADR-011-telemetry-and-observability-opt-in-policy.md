...
> **Status**: AMENDED — 2026-05-14 — substrate-presence clarified per `docs/research/otel_day1_decision.md` (no-op via API-only; SDK demoted to `[project.optional-dependencies] observability`). Originally ACCEPTED — 2026-05-13 (founder blanket approval per FOUNDER_ACTION_QUEUE.md §0).
...
- Worker M: `docs/research/opentelemetry.md` · Worker X: `docs/research/observability_backends.md` · Daft/Scarf: `docs/research/daft.md` §8 row 4
...
### Amendment 2026-05-14 — Option α-split per `docs/research/otel_day1_decision.md`
