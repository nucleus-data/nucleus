...
Log every catch in `docs/research/ai_hallucinations.md` per AGENTS.md §11.12.
...
- [ ] **VictoriaMetrics** + **VictoriaLogs** — ingest APIs, retention, cardinality limits, OTLP receiver maturity. Write `docs/research/victoriametrics.md` and `docs/research/victorialogs.md`. https://docs.victoriametrics.com/ • https://docs.victoriametrics.com/victorialogs/
...
- [ ] **OpenLineage ↔ OTEL trace_id convention** once `docs/research/openlineage.md` lands. Co-design with §4.4.
...
*Last verified: 2026-05-13 against `opentelemetry-api / opentelemetry-sdk == 1.29.0` (pinned in `pyproject.toml`) and latest `1.41.1` on PyPI. Re-verify when (a) opening the v0.5 observability ADR, (b) opening the `1.29 → 1.41` upgrade ADR, or (c) any major bump (`1.x → 2.x`). Log AI-fabricated OTEL APIs caught in PR review to [`docs/research/ai_hallucinations.md`](./ai_hallucinations.md).*
