...
> `docs/research/performance_reliability_targets.md` §10 #5 +
...
(Captured at `docs/research/windows_atomicity_results.json` for
reproducibility.)
...
| Performance / reliability gap doc | `docs/research/performance_reliability_targets.md` §6.2 + §10 #5 |
...
| Empirical results (this run) | `docs/research/windows_atomicity_results.json` |
