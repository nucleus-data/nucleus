...
Same host as `docs/research/benchmarks_v0.2.0.md` Section 1.1, so
...
* You need Dagster surface area Nucleus deliberately does NOT expose:
  ...
  See `docs/research/parity_vs_dbt_dagster_airflow.md` Section 3.2 for
  the gap list.
...
* Companion report: `docs/research/headtohead_dbt_duckdb.md`
* Executive summary: `docs/research/headtohead_summary.md`
* Parity research: `docs/research/parity_vs_dbt_dagster_airflow.md`
