...
| Prefect | Different shape -- flow/task vs asset. See `docs/research/parity_vs_dbt_dagster_airflow.md` Section 3.5. |
...
* `docs/research/headtohead_dbt_duckdb.md`
* `docs/research/headtohead_dagster_duckdb.md`
* `docs/research/benchmarks_v0.2.0.md` -- single-engine v0.2.0 baseline
* `docs/research/parity_vs_dbt_dagster_airflow.md` -- full parity matrix
