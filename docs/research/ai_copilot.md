...
| `docs/swap/litellm.md` + `docs/research/ai_hallucinations.md` audit + `nucleus_cli_spec.md` amendment (chat = 8th command) + ADR-006 NE4xxx allocation + README + SETUP changes | ~0.5 week | Swarm tier |
...
Log to `docs/research/ai_hallucinations.md` at first miss during implementation. No hallucinations to log from this research pass — every API surface above was double-checked against PyPI readme + linked docs.
