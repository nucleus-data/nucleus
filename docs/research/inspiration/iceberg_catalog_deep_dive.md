...
> **Complements** (do not repeat): `docs/research/inspiration/tier0_oss_evolution.md` §4 covers PyIceberg pin + underutilised features. Cross-reference that doc for `table.maintenance`, `table.upsert`, and anti-feature list.
