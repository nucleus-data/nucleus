...
> **Related docs:** `docs/research/ai_copilot.md` (LiteLLM v0.2 design) · `docs/research/strategic/ai_agent_data_infra_2026.md` (market angles A/C/D) · `docs/research/inspiration/big_cloud_platforms_recent.md` (Databricks/Snowflake AI — NOT repeated here).  
...
This is exactly what v0.2 Copilot specifies in `docs/research/ai_copilot.md` §2 + §4. No new frameworks. No autonomous execution. No runaway cost risk.
...
**Adoption:** 97M monthly SDK downloads, 10,000+ public servers, hosted by Claude Desktop, ChatGPT, Gemini, Cursor, VS Code, JetBrains, GitHub Copilot. MCP is no longer a thesis — it is the ambient AI protocol. Source: `docs/research/strategic/ai_agent_data_infra_2026.md` §3.1.
...
**Nucleus internal:** `nucleus_architecture_v4.1.md` §7–§8.3 · `docs/research/ai_copilot.md` · `docs/research/strategic/ai_agent_data_infra_2026.md` · `AGENTS.md` §3, §7, §11.12
