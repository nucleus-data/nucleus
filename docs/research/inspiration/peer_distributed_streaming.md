...
> **Related docs**: `docs/research/daft.md` (deep-dive), `docs/research/polars.md`, `nucleus_architecture_v4.1.md` §5.3, §10.2, §18.4
...
> Note: A deep-dive research doc already exists at `docs/research/daft.md` (last verified 2026-05-13 against `daft==0.7.11`). This section adds the Nucleus distributed-tier framing, benchmarks, and March 2026 roadmap updates.
...
Per official docs `architecture/` §Optimization and Nucleus `docs/research/daft.md` §4.1:
...
Source: `https://docs.pola.rs/user-guide/concepts/streaming/` (verified 2026-05-15) and `docs/research/polars.md` §7.6.
...
1. `pl.scan_iceberg` in `polars==1.18.0` works for read — confirmed in `docs/research/polars.md`
...
| **4** | Wrap Daft as optional engine for multimodal assets | **v0.5** | Gate: empirical ML-team demand in v0.3 beta telemetry; `docs/research/daft.md` has full spec |
...
The following AI-memory claims were evaluated and corrected during this research pass. Appended to `docs/research/ai_hallucinations.md` as well.
