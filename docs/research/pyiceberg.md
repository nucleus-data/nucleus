...
*Maintained by: Solo founder. Next review trigger: any PyIceberg upgrade PR, or when an ADR is opened to bump 0.8.1 → 0.9.x. Log hallucinated PyIceberg APIs caught in review in [`docs/research/ai_hallucinations.md`](./ai_hallucinations.md).*
