...
**Flagged for PoC #1 to verify** (names appear in `sequence_error_translation.md` §4.1 but I could not pin them to the 1.9.5 errors page — possible AI drift; log results to `docs/research/ai_hallucinations.md`):
