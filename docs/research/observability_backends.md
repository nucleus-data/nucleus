...
Log every catch in [`docs/research/ai_hallucinations.md`](./ai_hallucinations.md) per AGENTS.md §11.12.
...
- [ ] **DataHub vs Marquez decision matrix** — if user feedback or `docs/research/strategic/solo_oss_patterns_and_iceberg_2026.md` pushes Mesh, DataHub is the natural beachhead.
