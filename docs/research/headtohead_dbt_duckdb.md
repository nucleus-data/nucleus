...
`docs/research/benchmarks_v0.2.0.md` Section 1.1, so cross-reference
...
Based on the v0.2.0 baseline (`docs/research/benchmarks_v0.2.0.md`):
...
`docs/research/parity_vs_dbt_dagster_airflow.md` Section 6) wraps a
...
* Single-engine baseline: `docs/research/benchmarks_v0.2.0.md`
* Companion report: `docs/research/headtohead_dagster_duckdb.md`
* Executive summary: `docs/research/headtohead_summary.md`
