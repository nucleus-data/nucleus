...
**Verification mandatory at v0.3**: trigger each in a fixture (mirror PoC #1's 50-scenario harness). Some entries above are **unverified**. Log drift to `docs/research/ai_hallucinations.md`.
...
*Last verified: 2026-05-13 against dlt 1.26.0. Re-verify when opening the v0.3 ADR, before pinning, or on any major bump (1.x → 2.x). Log any AI-fabricated dlt APIs caught in PR review to [`docs/research/ai_hallucinations.md`](./ai_hallucinations.md).*
