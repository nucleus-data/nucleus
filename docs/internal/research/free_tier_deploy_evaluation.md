...
|---|---|---|
| JupyterLab as notebook | `nucleus.mdc` Tier picks Marimo; Jupyter is swap target | `AGENTS.md §4`, `nucleus.mdc` line 30, `docs/internal/research/marimo.md` |
...
- Owner: founder (no action). `nucleus.mdc` Tier line 30 + `docs/internal/research/marimo.md` remain canonical. 8-Q gate Q4 (no-JVM) fails for Zeppelin; Q8 fails for both. Effort: 0.
