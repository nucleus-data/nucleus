...
- **DuckLake is the only first-class lakehouse format dbt-duckdb supports natively** (`is_ducklake: true`, `partitioned_by=[...]`). DuckLake is the DuckDB Foundation's own format — **not** Iceberg. See `docs/internal/research/ducklake.md`.
