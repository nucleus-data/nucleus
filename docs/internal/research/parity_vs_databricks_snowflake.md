...
**How**: OpenLineage + sqlglot AST parsing, planned at v4.1 §12.4. Wire into AMA's lineage emission step. Python lineage deferred to v1.0 per decision D15 ([github.com/tobymao/sqlglot](https://github.com/tobymao/sqlglot)). Risk: complex CTEs + window functions — see `docs/internal/research/sqlglot.md §5`.
...
Appended to `docs/internal/research/ai_hallucinations.md`:
