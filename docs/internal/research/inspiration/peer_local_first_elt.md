...
> **Target file**: `docs/internal/research/inspiration/peer_local_first_elt.md`
>
> **Note on prior Nucleus research**: `docs/internal/research/dlt.md` covers dlt as an _integration_
> (ADR-014, pinned at `1.26.0`). `docs/internal/research/ducklake.md` covers DuckLake as a _threat_
...
4. **DuckLake as optional v0.3 catalog target?**
   `docs/internal/research/ducklake.md` marks DuckLake as a "watch item" (not a swap target). But
