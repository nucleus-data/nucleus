...
- **[I'm evaluating Nucleus vs Databricks / Snowflake / dbt]** → [Why Nucleus](why-nucleus.md) + [parity research](https://github.com/nucleus-data/nucleus/blob/main/docs/research/parity_vs_databricks_snowflake.md).
