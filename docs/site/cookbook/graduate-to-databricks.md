...
Per `docs/research/parity_vs_databricks_snowflake.md` section 1, Iceberg portability between Nucleus and Databricks is documented but not yet field-tested. Treat the following as known unknowns:
