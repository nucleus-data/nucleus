...
**Nucleus** is a modern, composable data engineering platform — built on open Apache foundations, AI-assisted by design, solving persistent pains. It grows with the team and graduates cleanly to cloud giants (Databricks/Snowflake) when users outgrow it.

It is **not** a database, a SQL engine, a DataFrame engine, an orchestrator, a Spark replacement, a Databricks competitor, a "Data OS", an ML platform, or a vector database. Treat any drift toward those framings as a bug.
...
**Design locked at v4.1, pre-implementation.** No production code exists yet.
...
[ ] PoC #1: Dagster Error Translation Layer  ← STARTS NEXT
[ ] PoC #2-5 validated
[ ] Open questions in v4.1 Appendix B answered
[ ] Go/No-Go gate held
[ ] v0.1 implementation
```

Do **not** propose v0.1 code changes until PoCs pass and Go/No-Go records GO.
...
`nucleus_architecture_v4.md` and `nucleus_architecture_v3.md` are **deprecated**. Use only as historical reference.
...
- ❌ "Data OS"
- ❌ "Spark killer"
- ❌ "Databricks killer / replacement"
- ❌ "Universal compute platform"
- ❌ "Own every layer"
- ❌ "AI-first platform" / "AI-native platform" (we are AI-assisted, not AI-native)
...
Correct framing: **a modern, composable data engineering platform that solves persistent pains, AI-assisted by design, and graduates cleanly to giants when users outgrow it.**
...
These are not failures — they are signals to revisit `nucleus_architecture_v4.md`.
