...
- [ ] Update `nucleus_architecture_v4.1.md` §6.4 — drop "PoC #1 validates feasibility" caveat; promote draft → shipping.
- [ ] Append row to `docs/decisions/ADR-002-positioning-decision-2026-05.md` §8.6 apply log.
- [ ] Mark PoC #1 COMPLETE in `nucleus_poc_plan.md` §1 + flip `[ ] PoC #1` checkbox in `AGENTS.md` §1 to `[✓]`.
...
- [ ] Beachhead E2E passes — or log "deferred until PoC #5 lands" in PR description if `nucleus_poc_plan.md` §5 not yet implemented.
