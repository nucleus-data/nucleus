...
2. **Verify the `_open_catalog` `# NEEDS VERIFICATION` marker** against a real PyIceberg 0.8.1 install on Win + macOS + Linux (ADR-001 cross-platform mandate). Log drift in `docs/research/ai_hallucinations.md`.
